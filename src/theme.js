import { hexToRgb, _popOutput, _printHTML, rgbToGray } from './tool';
...
export async function main(ns) {
  ...
  _printHTML(`<span style='line-height:1.2;margin:0;user-select:none;'>${html.substring(0, html.length - 2)}</p>`);
}
